<!-- CODE FROM 'http://forum.developers.facebook.com/viewtopic.php?id=7002' */ --> 
<link rel="stylesheet" type="text/css" media="screen" href="http://cs410-facebookphotocontest.appspot.com/css/calendar.css?v=1.2" />
<script src="http://cs410-facebookphotocontest.appspot.com/javascript/calendar.js?v=1.0"></script>

<div id="divCalender" class="fb_calendar_container" style="display: none;">
